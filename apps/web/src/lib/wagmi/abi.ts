export const TURING_HUNT_ABI = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'playerWithMostVotes', type: 'uint8', internalType: 'uint8' },
    ],
    stateMutability: 'view',
  },
  {
    type: 'function',
    name: 'getGame',
    inputs: [{ name: '_gameId', type: 'string', internalType: 'string' }],
    outputs: [
      {
        name: '',
        type: 'tuple',
  ...
  },
  {
    ...
    name: 'vote',
    inputs: [
      { name: '_gameId', type: 'string', internalType: 'string' },
